var world2State= {
 ...
 create:function() {
    ...
    mondo1_1=game.add.button(game.width/2-300,game.height/2,'lvl1verde',this.flvl2_1,this);
    
    //lettura del valore del cookie L1 true/false.
    var status_level= this.getCookie_L1("mondo2");
    if(status_level == "true"){
        mondo1_2=game.add.button(game.width/2+300,game.height/2,'lvl2verde',this.flvl2_2,this);
    }else{

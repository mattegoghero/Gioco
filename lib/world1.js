var world1State= {
 ...
 create:function() {
    ...
    mondo1_1=game.add.button(game.width/2-300,game.height/2,'lvl1verde',this.flvl1_1,this);
    
    //lettura del valore del cookie L1 true/false.
    var status_level= this.getCookie_L1("mondo1");
    if(status_level == "true"){
        mondo1_2=game.add.button(game.width/2+300,game.height/2,'lvl2verde',this.flvl1_2,this);
    }else{
    ...
    /*var stringa= "Mondo 1:" + stringa.fontColor("red")+stringa.fontSize(18);
    game.add.text(300,300,stringa);*/
    mondo1_1.anchor.setTo(0.5,0.5);
    mondo1_2.anchor.setTo(0.5,0.5);
    mondo1_1.scale.setTo(0.5,0.5);
    mondo1_2.scale.setTo(0.5,0.5);
    ...
    getCookie_L1: function(cname){
        ...
        var status= decodeCookie.substring(point+1, endpoint);
        return status;
    },
};
...
var level1_2 = {
    create : function () {
        ...
        game.add.image (0,-8,'background');
        game.stage.backgroundColor = "#ffffff";
        this.map = game.add.tilemap ('map1_2');
        this.map.addTilesetImage ('scenariodef');
        this.scenario = this.map.createLayer ('Scenario2');
    ...
    createworld : function () {
        ...
        var acquapos = [920,3086,5252,8200];
        for (i=0;i<acquapos.length;i++){
            this.acquamove = game.add.sprite(acquapos[i],781,'acquamove',0,this.water);
            this.acquamove.animations.add ('move',[0,1,2],3,true);
            this.acquamove.animations.play ('move');
        };
        game.physics.arcade.enable (this.water);
        this.mondo = this.map.createLayer ('Mondo2');
        this.acqua = this.map.createLayer ('Acqua2');
        ...
        this.nemici = game.add.tilemap ('Nemici1_2');
    ...
    createacqua: function() {
    //create doors
    this.acquatiles = this.game.add.group();
    this.acqua1 = game.add.sprite (905,805,'limit',0,this.acquatiles);
    this.acqua2 = game.add.sprite (2000,805,'limit',0,this.acquatiles);
    this.acqua3 = game.add.sprite (3820,805,'limit',0,this.acquatiles);
    this.acqua4 = game.add.sprite (4530,805,'limit',0,this.acquatiles);
    this.acqua5 = game.add.sprite (5360,805,'limit',0,this.acquatiles);
    this.acqua6 = game.add.sprite (6960,805,'limit',0,this.acquatiles);
    this.acqua7 = game.add.sprite (9840,805,'limit',0,this.acquatiles);
        game.physics.arcade.enable (this.acquatiles);
        this.acqua1.body.setSize(470,186);
        this.acqua2.body.setSize(1183,186);
        this.acqua3.body.setSize(300,186);
        this.acqua4.body.setSize(239,186);
        this.acqua5.body.setSize(1364,186);
        this.acqua6.body.setSize(2134,186);
        this.acqua7.body.setSize(714,186);
    },
    gameovery : function (){
        game.add.tween(this.reallife.scale).to({x: 0.33*life, y:1},1000).start();
        //game.state.start ('level1_2');
